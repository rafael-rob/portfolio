      ...
      <div className="flex-[3] w-full">
        <Card className="w-full p-4 flex flex-col gap-2 w-full">
          ...
          <div className="flex flex-col gap-4">
            {SIDE_PROJETCS.map((project, index) => (
              <SideProject
                key={index}
                Logo={project.Logo}
                title={project.title}
